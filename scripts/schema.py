...
model_schema = {
    ...
    "loop_func": merge(tstring, default("z=f(x+z)"), allowed(
        ["z=f(x+z)", "z=f(x*z)"])),
    "save_n_tokens": merge(tfloat, default(0)),
    "feed_block": merge(tboolean, default(False)),
    "use_ssm": merge(tboolean, default(False)),
    "skip_connection": merge(tboolean, default(False))
}
...
training_schema = {
    ...
    "test_every_steps": merge(tinteger, default(100)),
